...
description: 在每轮对话结束/用户显式指定调用这个 skill 时，扫描所有信息的内容，对比 AGENTS.md、.agents/local-docs-index.md、.agents/remote-docs-index.md、.agents/constraints.md 文件， 检测是否有上下文需要更新。
---
